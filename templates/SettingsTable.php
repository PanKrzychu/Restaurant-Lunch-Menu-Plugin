...
class SettingsTable extends WP_List_Table {
    ...
    function __construct(){
        ...
        parent::__construct( array(
            'singular'  => 'lunch',     //singular name of the listed records
            'plural'    => 'lunches',    //plural name of the listed records
    ...
    function column_default($item, $column_name){
        switch($column_name){
            ...
            case 'date':
                return $item[$column_name];
            default:
                return print_r($item[$column_name]); //Show the whole array for troubleshooting purposes
        }
    }
    ...
    function column_date($item){
        ...
        //Build row actions
        $actions = array(
            'edit'      => sprintf('<a href="?page=%s&action=%s&lunch=%s">Edit</a>',$_REQUEST['page'],'edit',$item['id']),
            'delete'    => sprintf('<a href="?page=%s&action=%s&lunch=%s">Delete</a>',$_REQUEST['page'],'delete',$item['id']),
        );
 ...
 */
function render_settings_table(){
    ...
    if (isset($_SESSION['table_message'])) {
        echo ("
            <div class='message " . $_SESSION['table_message'][1] . "'><p>" . $_SESSION['table_message'][0] . "</p></div>
        ");
        unset($_SESSION['table_message']);
    }
        ?>
